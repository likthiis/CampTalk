...
class OptionAdapter extends ArrayAdapter<Option> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Option option = getItem(position);//实例指定位置的水果

        viewHolder.ivImage.setImageResource(option.getImageId());
        viewHolder.tvName.setText(option.getImageName());
        return view;
    }
}